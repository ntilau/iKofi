...
#define DSS_PRIV_FILENAME     ikofi_conf_file("dropbear_dss_host_key")
#define RSA_PRIV_FILENAME     ikofi_conf_file("dropbear_rsa_host_key")
#define ECDSA_PRIV_FILENAME   ikofi_conf_file("dropbear_ecdsa_host_key")
#define ED25519_PRIV_FILENAME ikofi_conf_file("dropbear_ed25519_host_key")

#define DROPBEAR_PIDFILE      ikofi_conf_file("dropbear.pid")

#define DROPBEAR_SFTPSERVER 1
#define SFTPSERVER_PATH       ikofi_exe_to_lib("sftp-server")
 ...
 * IKOFI_EXTEND_AUTHENTICATION switch. */
