...
/* Define to 1 if your system has a GNU libc compatible 'malloc' function, and
   to 0 otherwise. */
/* IKOFI_REQUIRED_CHANGE: configure fails to find it due to android using an "#include_next" */
...
/* IKOFI_REQUIRED_CHANGE: configure added this, but must be commented out! set to 0 is not enough? */
...
/* IKOFI_REQUIRED_CHANGE don't redefine this */
...
/* IKOFI_REQUIRED_CHANGE: 64 versus 32 bit differences. */
...
/* IKOFI_REQUIRED_CHANGE: configure does not check this, but we need it. */
#define HAVE_ATTRIBUTE__SENTINEL__ 1

/* IKOFI_REQUIRED_CHANGE, see "openbsd-compat/explicit_bzero.c" workaround */
#define HAVE_BZERO 1
/* IKOFI_REQUIRED_CHANGE end */
